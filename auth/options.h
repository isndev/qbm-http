...
private:
    ...
    std::chrono::seconds       _clock_skew_tolerance{0}; ///< Clock skew tolerance for time-based claim validation (default: 0s).
...
public:
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& public_key(std::string key) { // Pass by value for potential move
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& private_key(std::string key) { // Pass by value for potential move
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& token_issuer(std::string issuer) { // Pass by value
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& token_audience(std::string audience) { // Pass by value
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& auth_header_name(std::string name) { // Pass by value
     ...
     * @return Reference to this `Options` object for chaining.
     */
    Options& auth_scheme(std::string scheme) { // Pass by value
    ...
    [[nodiscard]] std::chrono::seconds get_clock_skew_tolerance() const noexcept { return _clock_skew_tolerance; }
    ...
    [[nodiscard]] bool get_require_signature_verification() const noexcept { return _require_signature_verification; }
