...
public:
     ...
     */
    Options &
    secret_key(std::vector<unsigned char> &&secret) noexcept {
     ...
     */
    Options &
    algorithm(Algorithm alg) noexcept {
        _algorithm = alg;
        return *this;
    }
     ...
     */
    Options &
    token_expiration(std::chrono::seconds seconds) noexcept {
     ...
     */
    Options &
    token_issuer(std::string issuer) {
        // Pass by value
     ...
     */
    Options &
    token_audience(std::string audience) {
        // Pass by value
     ...
     */
    Options &
    auth_header_name(std::string name) {
        // Pass by value
     ...
     */
    Options &
    require_signature_verification(bool verify) noexcept {
     ...
     */
    Options &
    verify_expiration(bool verify) noexcept {
     ...
     */
    Options &
    verify_not_before(bool verify) noexcept {
     ...
     */
    Options &
    clock_skew_tolerance(std::chrono::seconds tolerance) noexcept {
