...
class ValidationMiddleware final : public IMiddleware<SessionType> {
public:
     ...
     */
    explicit ValidationMiddleware(std::shared_ptr<qb::http::validation::RequestValidator> validator, std::string name = "ValidationMiddleware")
 ...
 */
template <typename SessionType>
[[nodiscard]] std::shared_ptr<ValidationMiddleware<SessionType>>
validation_middleware(std::shared_ptr<qb::http::validation::RequestValidator> validator, const std::string &name = "ValidationMiddleware") {
