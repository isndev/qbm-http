...
public:
    ...
    with_hsts(const std::string &value) {
        _hsts_value = value;
        return *this;
    }
    ...
    SecurityHeadersOptions &
    with_x_content_type_options_nosniff(bool enable = true) {
        _set_x_content_type_options_nosniff = enable;
        return *this;
    }

    SecurityHeadersOptions &
    with_x_frame_options(const std::string &value) {
    ...
    SecurityHeadersOptions &
    with_content_security_policy(const std::string &value) {
        _content_security_policy_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_content_security_policy() {
        _content_security_policy_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_content_security_policy_report_only(const std::string &value) {
        _csp_report_only_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_content_security_policy_report_only() {
        _csp_report_only_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_referrer_policy(const std::string &value) {
    ...
    SecurityHeadersOptions &
    with_permissions_policy(const std::string &value) {
    ...
    SecurityHeadersOptions &
    with_cross_origin_opener_policy(const std::string &value) {
        _coop_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_cross_origin_opener_policy() {
        _coop_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_cross_origin_embedder_policy(const std::string &value) {
        _coep_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_cross_origin_embedder_policy() {
        _coep_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_cross_origin_resource_policy(const std::string &value) {
        _corp_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_cross_origin_resource_policy() {
        _corp_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_x_permitted_cross_domain_policies(const std::string &value) {
        _x_permitted_cross_domain_policies_value = value;
        return *this;
    }

    SecurityHeadersOptions &
    without_x_permitted_cross_domain_policies() {
        _x_permitted_cross_domain_policies_value.reset();
        return *this;
    }

    SecurityHeadersOptions &
    with_csp_nonce(bool enable = true) {
    ...
    get_hsts_value() const {
        return _hsts_value;
    }

    [[nodiscard]] bool
    get_set_x_content_type_options_nosniff() const {
        return _set_x_content_type_options_nosniff;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_x_frame_options_value() const {
        return _x_frame_options_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_content_security_policy_value() const {
        return _content_security_policy_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_csp_report_only_value() const {
        return _csp_report_only_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_referrer_policy_value() const {
        return _referrer_policy_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_permissions_policy_value() const {
        return _permissions_policy_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_coop_value() const {
        return _coop_value;
    }
    [[nodiscard]] const std::optional<std::string> &
    get_coep_value() const {
        return _coep_value;
    }
    [[nodiscard]] const std::optional<std::string> &
    get_corp_value() const {
        return _corp_value;
    }

    [[nodiscard]] const std::optional<std::string> &
    get_x_permitted_cross_domain_policies_value() const {
        return _x_permitted_cross_domain_policies_value;
    }

    [[nodiscard]] bool
    get_csp_nonce_enabled() const {
        return _enable_csp_nonce;
    }
...
public:
    ...
    explicit SecurityHeadersMiddleware(SecurityHeadersOptions options = SecurityHeadersOptions::secure_defaults(),
    ...
    process(ContextPtr ctx) override {
        ...
        ctx->add_lifecycle_hook([options_capture](Context<SessionType> &ctx_ref, HookPoint point) {
                ...
                if (opts.get_csp_nonce_enabled()) {
                    ...
                    if (nonce_opt) {
                        ...
                        if (!opts.get_content_security_policy_value().has_value()) {
                            ...
                            std::string default_csp_with_nonce = "default-src 'self'; "
    ...
    void
    update_options(const SecurityHeadersOptions &new_options) {
...
security_headers_middleware(const SecurityHeadersOptions &options = SecurityHeadersOptions::secure_defaults(),
