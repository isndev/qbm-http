...
namespace qb::http {
    ...
    public:
        ...
        [[nodiscard]] bool get_set_x_content_type_options_nosniff() const {
            return _set_x_content_type_options_nosniff;
        }

        [[nodiscard]] const std::optional<std::string> &get_x_frame_options_value() const {
            return _x_frame_options_value;
        }

        [[nodiscard]] const std::optional<std::string> &get_content_security_policy_value() const {
            return _content_security_policy_value;
        }

        [[nodiscard]] const std::optional<std::string> &get_csp_report_only_value() const {
            return _csp_report_only_value;
        }

        [[nodiscard]] const std::optional<std::string> &get_referrer_policy_value() const {
            return _referrer_policy_value;
        }

        [[nodiscard]] const std::optional<std::string> &get_permissions_policy_value() const {
        ...
        [[nodiscard]] const std::optional<std::string> &get_x_permitted_cross_domain_policies_value() const {
        ...
        static SecurityHeadersOptions secure_defaults() {
            ...
            opts._content_security_policy_value =
                ...
                [options_capture](Context<SessionType> &ctx_ref, HookPoint point) {
                    if (point == HookPoint::PRE_RESPONSE_SEND) {
                        ...
                        if (opts.get_csp_nonce_enabled()) {
                            ...
                            if (nonce_opt) {
                                ...
                                if (!opts.get_content_security_policy_value().has_value()) {
                                    ...
                                    ctx_ref.response().set_header("Content-Security-Policy",
                                                                  *opts.get_content_security_policy_value());
                                }
                            }
                        ...
                        if (opts.get_csp_report_only_value()) {
                            ctx_ref.response().set_header("Content-Security-Policy-Report-Only",
                                                          *opts.get_csp_report_only_value());
                        }
                        ...
                        if (opts.get_x_permitted_cross_domain_policies_value()) {
                            ctx_ref.response().set_header("X-Permitted-Cross-Domain-Policies",
                                                          *opts.get_x_permitted_cross_domain_policies_value());
                        }
                    }
                });
