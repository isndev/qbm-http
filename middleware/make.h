...
template <typename SessionType, typename... Args>
[[nodiscard]] auto
make_dispatch(tags::logging, Args &&...args) {
    return qb::http::logging_middleware<SessionType>(std::forward<Args>(args)...);
}

template <typename SessionType, typename... Args>
[[nodiscard]] auto
make_dispatch(tags::timing, Args &&...args) {
...
template <typename SessionType, typename... Args>
[[nodiscard]] auto
make_dispatch(tags::security_headers, Args &&...args) {
    return qb::http::security_headers_middleware<SessionType>(std::forward<Args>(args)...);
}

template <typename SessionType, typename... Args>
[[nodiscard]] auto
make_dispatch(tags::static_files, Args &&...args) {
...
template <typename SessionType, typename... Args>
[[nodiscard]] auto
make_dispatch(tags::jwt, Args &&...args) {
