...
namespace qb::http {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::add_route(std::string path, qb::http::method method,
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::get(std::string path,
                                                  std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::post(std::string path,
                                                   std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::put(std::string path,
                                                  std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::del(std::string path,
                                                  std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::patch(std::string path,
                                                    std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::options(std::string path,
                                                      std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::head(std::string path,
                                                   std::shared_ptr<ICustomRoute<SessionType> > custom_route) {
        if (_root_group) {
    ...
    Router<SessionType> &Router<SessionType>::add_custom_route(std::string path, qb::http::method method,
                                                               Args &&... ctor_args) {
        if (_root_group) {
            _root_group->template add_custom_route<CustomRouteType>(std::move(path), method,
    ...
    std::shared_ptr<C> Router<SessionType>::controller(std::string path_prefix, Args &&... args) {
        _is_compiled = false;
        return _root_group
                   ? _root_group->template controller<C>(std::move(path_prefix), std::forward<Args>(args)...)
                   : nullptr;
    }
    ...
    template<typename SessionType>
    Router<SessionType> &Router<SessionType>::use(std::shared_ptr<IMiddleware<SessionType> > mw_ptr,
    ...
    template<typename SessionType>
    std::shared_ptr<Context<SessionType> > Router<SessionType>::route(std::shared_ptr<SessionType> session,
