...
public:
     ...
     */
    void
    set(std::string_view key, std::string_view value_sv) {
     ...
     */
    void
    swap(PathParameters &other) noexcept {
     ...
     */
    [[nodiscard]] auto
    find(std::string_view key) noexcept {
     ...
     */
    auto
    erase(typename Storage::iterator pos) noexcept {
     ...
     */
    auto
    erase(typename Storage::const_iterator first, typename Storage::const_iterator last) noexcept {
     ...
     */
    auto
    erase(std::string_view key) noexcept {
