...
namespace qb::http {
    ...
    protected:
         ...
         */
        Controller<Session> &add_controller_route(std::string path, qb::http::method method,
                                                  RouteHandlerFn<Session> handler_fn) {
         ...
         */
        Controller<Session> &add_controller_route(std::string path, qb::http::method method,
                                                  std::shared_ptr<ICustomRoute<Session> > custom_route_ptr) {
        ...
        Controller<Session> &add_controller_custom_route(std::string path, qb::http::method method,
                                                         Args &&... ctor_args) {
            static_assert(std::is_base_of_v<ICustomRoute<Session>, CustomRouteType>,
                          "CustomRouteType must derive from ICustomRoute<Session>");
    ...
    public:
        ...
        template<typename CustomRouteType, typename... Args, typename = std::enable_if_t<std::is_base_of_v<ICustomRoute<
            Session>, CustomRouteType> > >
        Controller<Session> &get(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::GET,
        ...
        Controller<Session> &post(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::POST,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        Controller<Session> &put(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::PUT,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        Controller<Session> &del(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::DEL,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        Controller<Session> &patch(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::PATCH,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        Controller<Session> &options(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::OPTIONS,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        Controller<Session> &head(std::string path, Args &&... ctor_args) {
            return add_controller_custom_route<CustomRouteType>(std::move(path), qb::http::method::HEAD,
                                                                std::forward<Args>(ctor_args)...);
        }
        ...
        void compile_tasks_and_register(
            ...
            for (const auto &route_node: _controller_routes) {
                if (route_node) {
                    ...
                    route_node->compile_tasks_and_register(router_core, controller_base_path,
                                                           tasks_for_controller_routes);
                }
            }
        }
    };
