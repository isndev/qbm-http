...
// ---------------------------------------------------------------------------
// Pure-logic coverage for the qb::protocol::http3::detail field-validation and
// field-block-assembly helpers (RFC 9114 / RFC 7230). These need no QUIC stack
// and extend the Http3ProtocolValidationTest suite declared above.
// ---------------------------------------------------------------------------
