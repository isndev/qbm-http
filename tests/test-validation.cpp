...
TEST_F(ValidationLogicTest, TypeRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(string_rule.validate(qb::json("hello"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(string_rule.validate(qb::json(123), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(int_rule.validate(qb::json(123), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(int_rule.validate(qb::json(123.5), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_FALSE(int_rule.validate(qb::json("123"), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(num_rule.validate(qb::json(123), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(num_rule.validate(qb::json(123.5), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(num_rule.validate(qb::json("123.5"), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(bool_rule.validate(qb::json(true), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(bool_rule.validate(qb::json(1), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(obj_rule.validate(qb::json::object(), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(obj_rule.validate(qb::json::array(), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(arr_rule.validate(qb::json::array(), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(arr_rule.validate(qb::json::object(), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(null_rule.validate(qb::json(nullptr), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(null_rule.validate(qb::json(0), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(any_rule.validate(qb::json("any_value"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(any_rule.validate(qb::json(nullptr), "test", result)); EXPECT_TRUE(result.success());
}

TEST_F(ValidationLogicTest, MinLengthRuleValidation) {
    MinLengthRule rule(3);
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("abc"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("abcd"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json("ab"), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1,2,3}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({1,2}), "test", result)); EXPECT_FALSE(result.success());
    
    result.clear(); EXPECT_TRUE(rule.validate(qb::json(123), "test", result)); 
    EXPECT_TRUE(result.success());
}
...
TEST_F(ValidationLogicTest, MaxLengthRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("abc"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("ab"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json("abcd"), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1,2,3}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({1,2,3,4}), "test", result)); EXPECT_FALSE(result.success());
...
TEST_F(ValidationLogicTest, PatternRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("abcXYZ"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json("abc123"), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json(""), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json(123), "test", result)); EXPECT_TRUE(result.success());
...
TEST_F(ValidationLogicTest, MinimumRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule_incl.validate(qb::json(10.0), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule_incl.validate(qb::json(10.1), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule_incl.validate(qb::json(9.9), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_FALSE(rule_excl.validate(qb::json(10.0), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_TRUE(rule_excl.validate(qb::json(10.0001), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule_excl.validate(qb::json(9.9), "test", result)); EXPECT_FALSE(result.success());
    
    result.clear(); EXPECT_TRUE(rule_incl.validate(qb::json("test"), "test", result)); EXPECT_TRUE(result.success()); 
}
...
TEST_F(ValidationLogicTest, MaximumRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule_incl.validate(qb::json(20.0), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule_incl.validate(qb::json(19.9), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule_incl.validate(qb::json(20.1), "test", result)); EXPECT_FALSE(result.success());

    result.clear(); EXPECT_FALSE(rule_excl.validate(qb::json(20.0), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_TRUE(rule_excl.validate(qb::json(19.9999), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule_excl.validate(qb::json(20.1), "test", result)); EXPECT_FALSE(result.success());
}

TEST_F(ValidationLogicTest, EnumRuleValidation) {
    EnumRule rule(qb::json::array({"red", "green", "blue", 10}));
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("green"), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json(10), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json("yellow"), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json(20), "test", result)); EXPECT_FALSE(result.success());
...
TEST_F(ValidationLogicTest, UniqueItemsRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1, 2, 3, "a"}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({1, 2, 3, 2}), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array(), "test", result)); EXPECT_TRUE(result.success()); 
    result.clear(); EXPECT_TRUE(rule.validate(qb::json({{"a",1}, {"b",2}}), "test", result)); EXPECT_TRUE(result.success()); 
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({qb::json::object({{"a",1}}), qb::json::object({{"a",1}})}), "test", result)); EXPECT_FALSE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json(123), "test", result)); EXPECT_TRUE(result.success()); 
}

TEST_F(ValidationLogicTest, MinItemsRuleValidation) {
    MinItemsRule rule(2);
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1,2}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1,2,3}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({1}), "test", result)); EXPECT_FALSE(result.success());
}

TEST_F(ValidationLogicTest, MaxItemsRuleValidation) {
    MaxItemsRule rule(2);
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1,2}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(rule.validate(qb::json::array({1}), "test", result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_FALSE(rule.validate(qb::json::array({1,2,3}), "test", result)); EXPECT_FALSE(result.success());
}
...
TEST_F(ValidationLogicTest, CustomRuleValidation) {
    ...
    result.clear(); EXPECT_TRUE(rule.validate(qb::json("custom_valid"), "field", result)); EXPECT_TRUE(result.success());
    EXPECT_TRUE(custom_func_called);

    custom_func_called = false;
    result.clear(); EXPECT_FALSE(rule.validate(qb::json("invalid"), "field", result)); EXPECT_FALSE(result.success());
    EXPECT_TRUE(custom_func_called);
    ASSERT_EQ(result.errors().size(), 1);
...
TEST_F(ValidationLogicTest, SchemaValidatorNestedObject) {
    ...
    bool is_valid_1 = validator.validate(valid_data, result);
    EXPECT_TRUE(is_valid_1); EXPECT_TRUE(result.success());
...
TEST_F(ValidationLogicTest, SchemaValidatorTupleItemsAndAdditionalItems) {
    ...
    EXPECT_TRUE(is_valid_4); EXPECT_TRUE(result.success());
...
TEST_F(ValidationLogicTest, SchemaValidatorAdditionalProperties) {
    ...
    result.clear(); EXPECT_TRUE(validator_no_add.validate({{"name", "test"}}, result)); EXPECT_TRUE(result.success());
    result.clear(); 
    ...
    result.clear(); EXPECT_TRUE(validator_add_schema.validate({{"id", 1}, {"description", "text"}}, result)); EXPECT_TRUE(result.success());
    result.clear(); 
...
TEST_F(ValidationLogicTest, SchemaValidatorAllOf) {
    ...
    result.clear(); qb::json valid_data = {{"a", "text"}, {"b", 123}};
    bool is_valid_1 = validator.validate(valid_data, result);
    EXPECT_TRUE(is_valid_1); EXPECT_TRUE(result.success());

    result.clear(); qb::json schema_refined = {
        {"allOf", {
    ...
    EXPECT_TRUE(validator_refined.validate(valid_data, result)); EXPECT_TRUE(result.success());
    result.clear(); qb::json invalid_missing_b = {{"a", "text"}};
...
TEST_F(ValidationLogicTest, SchemaValidatorAnyOf) {
    ...
    result.clear(); EXPECT_TRUE(validator.validate(qb::json("longstring"), result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(validator.validate(qb::json(15), result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(validator.validate(qb::json(10), result)); EXPECT_TRUE(result.success()); 
...
TEST_F(ValidationLogicTest, SchemaValidatorOneOf) {
    ...
    result.clear(); EXPECT_TRUE(validator.validate(qb::json("abc"), result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(validator.validate(qb::json("def"), result)); EXPECT_TRUE(result.success());
    ...
    EXPECT_TRUE(outcome_longstring) << "'longstring' should match oneOf (minLength:2). Errors: " << validation_errors_to_json_helper(result.errors()).dump(2);
...
TEST_F(ValidationLogicTest, SchemaValidatorNot) {
    ...
    result.clear(); EXPECT_TRUE(validator.validate(qb::json("string"), result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(validator.validate(qb::json(true), result)); EXPECT_TRUE(result.success());
    result.clear(); EXPECT_TRUE(validator.validate(qb::json(10.5), result)); EXPECT_TRUE(result.success()); 
...
TEST_F(ValidationLogicTest, SchemaValidatorMinMaxProperties) {
    ...
    result.clear(); qb::json data_ok2 = {{"a", "val"}, {"b", 1}};
    EXPECT_TRUE(validator.validate(data_ok2, result)); EXPECT_TRUE(result.success());

    result.clear(); qb::json data_ok3 = {{"a", "val"}, {"b", 1}, {"c", true}};
    EXPECT_TRUE(validator.validate(data_ok3, result)); EXPECT_TRUE(result.success());

    result.clear(); qb::json data_too_few = {{"a", "val"}};
    EXPECT_FALSE(validator.validate(data_too_few, result));
    ASSERT_FALSE(result.success());
    ASSERT_EQ(result.errors().size(), 1);
    EXPECT_EQ(result.errors()[0].rule_violated, "minProperties");

    result.clear(); qb::json data_too_many = {{"a", "v"}, {"b", 1}, {"c", false}, {"d", "extra"}};
...
TEST_F(ValidationLogicTest, SchemaValidatorPropertyNames) {
    ...
    result.clear(); qb::json data_valid_names = {{"valid_name", 123}, {"another_ok", true}};
    EXPECT_TRUE(validator.validate(data_valid_names, result)); EXPECT_TRUE(result.success());

    result.clear(); qb::json data_invalid_name = {{"ValidName", 456}}; 
    ...
    result.clear(); qb::json data_invalid_char = {{"name_with_!", 789}};
...
TEST_F(ValidationLogicTest, ParameterValidatorRequired) {
    ...
    result.clear(); qb::icase_unordered_map<std::string> params_ok = {{"name", "value"}};
    EXPECT_TRUE(pv.validate(params_ok, result, "query")); EXPECT_TRUE(result.success());

    result.clear(); qb::icase_unordered_map<std::string> params_missing = {};
...
TEST_F(ValidationLogicTest, ParameterValidatorTypeConversionAndRule) {
    ...
    result.clear(); qb::icase_unordered_map<std::string> params_valid = {{"age", "20"}};
    EXPECT_TRUE(pv.validate(params_valid, result, "query")); EXPECT_TRUE(result.success());

    result.clear(); qb::icase_unordered_map<std::string> params_invalid_val = {{"age", "17"}};
    EXPECT_FALSE(pv.validate(params_invalid_val, result, "query"));
    ASSERT_EQ(result.errors().size(), 1);
    EXPECT_EQ(result.errors()[0].field_path, "query.age");
    EXPECT_EQ(result.errors()[0].rule_violated, "minimum");

    result.clear(); qb::icase_unordered_map<std::string> params_invalid_type = {{"age", "abc"}};
...
TEST_F(ValidationLogicTest, ParameterValidatorDefaultValue) {
    ...
    result.clear(); qb::json validated_json;
    bool success_flag;

    result.clear(); validated_json = pv.validate_single("limit", std::nullopt, ParameterRuleSet("limit").set_type(DataType::INTEGER).set_default("10").add_rule(std::make_shared<MinimumRule>(1)), result, "query");
    EXPECT_TRUE(result.success());
    ASSERT_TRUE(validated_json.is_number_integer());
    EXPECT_EQ(validated_json.get<long long>(), 10);

    result.clear(); validated_json = pv.validate_single("limit", std::make_optional<std::string>("5"), ParameterRuleSet("limit").set_type(DataType::INTEGER).set_default("10").add_rule(std::make_shared<MinimumRule>(1)), result, "query");
    EXPECT_TRUE(result.success());
    ASSERT_TRUE(validated_json.is_number_integer());
    EXPECT_EQ(validated_json.get<long long>(), 5);

    result.clear(); validated_json = pv.validate_single("limit", std::nullopt, ParameterRuleSet("limit").set_type(DataType::INTEGER).set_default("0").add_rule(std::make_shared<MinimumRule>(1)), result, "query");
    EXPECT_FALSE(result.success());
    ASSERT_EQ(result.errors().size(), 1);
    EXPECT_EQ(result.errors()[0].rule_violated, "minimum");
...
TEST_F(ValidationLogicTest, ParameterValidatorCustomParser) {
    ...
    auto custom_bool_parser = [](const std::string& input, bool& success) -> qb::json {
        ...
        if (lower_input == "yes" || lower_input == "on") { success = true; return true; }
        if (lower_input == "no" || lower_input == "off") { success = true; return false; }
        success = false;
        return nullptr;
    };
    ...
    result.clear(); qb::icase_unordered_map<std::string> params_yes = {{"enabled", "YES"}};
    ...
    qb::json parsed = pv.validate_single("enabled", std::make_optional<std::string>("YES"), 
                                         ParameterRuleSet("enabled").set_custom_parser(custom_bool_parser).set_type(DataType::BOOLEAN),
                                         result, "query");
    EXPECT_TRUE(result.success());
    ASSERT_TRUE(parsed.is_boolean());
    EXPECT_TRUE(parsed.get<bool>());

    result.clear(); qb::icase_unordered_map<std::string> params_invalid = {{"enabled", "maybe"}};
...
TEST_F(ValidationLogicTest, SanitizerTrim) {
    ...
    result.clear(); qb::json data = {{"name", "  test user  "}};
    s.sanitize(data);
...
TEST_F(ValidationLogicTest, SanitizerMultipleRulesOnField) {
    ...
    result.clear(); qb::json data = {{"comment", "  <Hello> World!  "}};
    s.sanitize(data);
...
TEST_F(ValidationLogicTest, SanitizerNestedPath) {
    ...
    result.clear(); qb::json data = {{"user", {{"profile", {{"bio", "  A long bio.  "}}}}}};
    s.sanitize(data);
...
TEST_F(ValidationLogicTest, SanitizerArrayIndexSpecific) {
    ...
    result.clear(); qb::json data = {{"users", {
        {{"name", "  Alice  "}},
        {{"name", "   Bob   "}},
        {{"name", "  Charlie  "}}
    }}};
...
TEST_F(ValidationLogicTest, SanitizerNormalizeWhitespace) {
    ...
    result.clear(); qb::json data1 = {{"text", "  hello    world  \t\n  next  "}};
    s.sanitize(data1);
    EXPECT_EQ(data1["text"].get<std::string>(), "hello world next");

    result.clear(); qb::json data2 = {{"text", "NoExtraSpaces"}};
    s.sanitize(data2);
    EXPECT_EQ(data2["text"].get<std::string>(), "NoExtraSpaces");

    result.clear(); qb::json data3 = {{"text", "   "}};
    s.sanitize(data3);
    EXPECT_EQ(data3["text"].get<std::string>(), ""); 

    result.clear(); qb::json data4 = {{"text", " leading space"}};
    s.sanitize(data4);
...
TEST_F(ValidationLogicTest, SanitizerEscapeSqlLike) {
    ...
    result.clear(); qb::json data1 = {{"search", "user%name"}};
    s.sanitize(data1);
    EXPECT_EQ(data1["search"].get<std::string>(), "user\\%name");

    result.clear(); qb::json data2 = {{"search", "customer_id"}};
    s.sanitize(data2);
    EXPECT_EQ(data2["search"].get<std::string>(), "customer\\_id");

    result.clear(); qb::json data3 = {{"search", "O'Malley's"}};
    s.sanitize(data3);
    ...
    result.clear(); qb::json data_combo = {{"search", "  test % _ '  "}};
...
TEST_F(ValidationLogicTest, ParameterValidatorMultiValueSupport) {
    ...
    result.clear(); std::vector<std::string> valid_values = {"10", "20", "30"};
    std::vector<std::string> invalid_values = {"15", "5", "25"}; 

    result.clear(); bool all_valid_pass = true;
    ...
    result.clear(); bool some_invalid_pass = true;
