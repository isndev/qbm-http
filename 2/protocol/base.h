...
public:
    ...
    /**
     * @brief Validate an HTTP/2 header value according to RFC 9113.
     * @details Rejects NUL/CR/LF and any other control byte except TAB (0x09),
     *          as well as DEL (0x7F).
     * @param value Raw header field value
     * @return true when the value contains no forbidden bytes
     */
     ...
     */
    static SettingsHelper::ValidationResult validate_request_pseudo_headers(const std::vector<qb::protocol::hpack::HeaderField> &headers);
     ...
     * @return Validation result with details
     */
    static SettingsHelper::ValidationResult validate_response_pseudo_headers(const std::vector<qb::protocol::hpack::HeaderField> &headers);
};
...
public:
     ...
     */
    static std::string format_error_message(ErrorCode error_code, const std::string &context, uint32_t stream_id = 0);
...
public:
     ...
     */
    static SettingsHelper::ValidationResult validate_stream_id_for_frame(FrameType frame_type, uint32_t stream_id, bool is_server);
