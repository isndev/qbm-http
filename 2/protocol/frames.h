...
struct FrameHeader {
     ...
     */
    [[nodiscard]] uint32_t
    get_payload_length() const noexcept {
        return (static_cast<uint32_t>(length_bytes[0]) << 16) | (static_cast<uint32_t>(length_bytes[1]) << 8)
     ...
     */
    void
    set_payload_length(uint32_t len) noexcept {
     ...
     */
    [[nodiscard]] uint32_t
    get_stream_id() const noexcept {
        return (static_cast<uint32_t>(stream_id_bytes[0] & 0x7F) << 24) | (static_cast<uint32_t>(stream_id_bytes[1]) << 16)
               | (static_cast<uint32_t>(stream_id_bytes[2]) << 8) | (static_cast<uint32_t>(stream_id_bytes[3]));
    }
     ...
     */
    void
    set_stream_id(uint32_t id) noexcept {
