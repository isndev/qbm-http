...
public:
    ...
    enum class Value : int {
        ...
        NON_AUTHORITATIVE_INFORMATION = ::HTTP_STATUS_NON_AUTHORITATIVE_INFORMATION, ///< 203 Non-Authoritative Information
        ...
        PROXY_AUTHENTICATION_REQUIRED = ::HTTP_STATUS_PROXY_AUTHENTICATION_REQUIRED, ///< 407 Proxy Authentication Required
        ...
        REQUEST_HEADER_FIELDS_TOO_LARGE = ::HTTP_STATUS_REQUEST_HEADER_FIELDS_TOO_LARGE, ///< 431 Request Header Fields Too Large (RFC 6585)
        UNAVAILABLE_FOR_LEGAL_REASONS = ::HTTP_STATUS_UNAVAILABLE_FOR_LEGAL_REASONS, ///< 451 Unavailable For Legal Reasons (RFC 7725)
        ...
        NETWORK_AUTHENTICATION_REQUIRED = ::HTTP_STATUS_NETWORK_AUTHENTICATION_REQUIRED, ///< 511 Network Authentication Required (RFC 6585)
        ...
        DISCONNECTED_OPERATION = ::HTTP_STATUS_DISCONNECTED_OPERATION, ///< (llhttp specific) Disconnected operation.
        ...
        TRANSFORMATION_APPLIED = ::HTTP_STATUS_TRANSFORMATION_APPLIED, ///< (llhttp specific) Transformation applied.
        MISCELLANEOUS_PERSISTENT_WARNING = ::HTTP_STATUS_MISCELLANEOUS_PERSISTENT_WARNING, ///< (llhttp specific) Miscellaneous persistent warning.
        SWITCH_PROXY = ::HTTP_STATUS_SWITCH_PROXY, ///< (llhttp specific, possibly related to 306 Switch Proxy, which is unused)
        ...
        REQUEST_HEADER_FIELDS_TOO_LARGE_UNOFFICIAL = ::HTTP_STATUS_REQUEST_HEADER_FIELDS_TOO_LARGE_UNOFFICIAL, ///< (llhttp specific, unofficial) Request header fields too large.
        ...
        BLOCKED_BY_PARENTAL_CONTROL = ::HTTP_STATUS_BLOCKED_BY_PARENTAL_CONTROL, ///< (llhttp specific, Microsoft) Blocked by Windows Parental Controls.
        CLIENT_CLOSED_LOAD_BALANCED_REQUEST = ::HTTP_STATUS_CLIENT_CLOSED_LOAD_BALANCED_REQUEST, ///< (llhttp specific) Client closed load balanced request.
        INVALID_X_FORWARDED_FOR = ::HTTP_STATUS_INVALID_X_FORWARDED_FOR, ///< (llhttp specific) Invalid X-Forwarded-For.
        REQUEST_HEADER_TOO_LARGE = ::HTTP_STATUS_REQUEST_HEADER_TOO_LARGE, ///< (llhttp specific) Request header too large (potentially distinct from 431).
        SSL_CERTIFICATE_ERROR = ::HTTP_STATUS_SSL_CERTIFICATE_ERROR, ///< (llhttp specific) SSL certificate error.
        SSL_CERTIFICATE_REQUIRED = ::HTTP_STATUS_SSL_CERTIFICATE_REQUIRED, ///< (llhttp specific) SSL certificate required.
        HTTP_REQUEST_SENT_TO_HTTPS_PORT = ::HTTP_STATUS_HTTP_REQUEST_SENT_TO_HTTPS_PORT, ///< (llhttp specific) HTTP request sent to HTTPS port.
        ...
        BANDWIDTH_LIMIT_EXCEEDED = ::HTTP_STATUS_BANDWIDTH_LIMIT_EXCEEDED, ///< (llhttp specific) Bandwidth limit exceeded.
        WEB_SERVER_UNKNOWN_ERROR = ::HTTP_STATUS_WEB_SERVER_UNKNOWN_ERROR, ///< (llhttp specific) Web server unknown error.
        ...
        INVALID_SSL_CERTIFICATE = ::HTTP_STATUS_INVALID_SSL_CERTIFICATE, ///< (llhttp specific) Invalid SSL certificate.
        ...
        IDENTITY_PROVIDER_AUTHENTICATION_ERROR = ::HTTP_STATUS_IDENTITY_PROVIDER_AUTHENTICATION_ERROR, ///< (llhttp specific) Identity provider authentication error.
        NETWORK_READ_TIMEOUT = ::HTTP_STATUS_NETWORK_READ_TIMEOUT,       ///< (llhttp specific) Network read timeout.
        NETWORK_CONNECT_TIMEOUT = ::HTTP_STATUS_NETWORK_CONNECT_TIMEOUT ///< (llhttp specific) Network connect timeout.
    };
    ...
    constexpr Status& operator=(Value v) { _value = v; return *this; }
    /// Assign from raw ::http_status.
    constexpr Status& operator=(::http_status s) { _value = static_cast<Value>(s); return *this; }
    /// Assign from an integer status code.
    constexpr Status& operator=(int i) { _value = static_cast<Value>(i); return *this; }
    ...
    /// Less-than comparison (for sorting, maps, sets, etc.).
    constexpr bool operator<(const Status& other) const { return static_cast<int>(_value) < static_cast<int>(other._value); }
    ...
    static constexpr Value NON_AUTHORITATIVE_INFORMATION = Value::NON_AUTHORITATIVE_INFORMATION; ///< @see Value::NON_AUTHORITATIVE_INFORMATION
    ...
    static constexpr Value PROXY_AUTHENTICATION_REQUIRED = Value::PROXY_AUTHENTICATION_REQUIRED; ///< @see Value::PROXY_AUTHENTICATION_REQUIRED
    ...
    static constexpr Value UNSUPPORTED_MEDIA_TYPE = Value::UNSUPPORTED_MEDIA_TYPE; ///< @see Value::UNSUPPORTED_MEDIA_TYPE
    static constexpr Value RANGE_NOT_SATISFIABLE = Value::RANGE_NOT_SATISFIABLE; ///< @see Value::RANGE_NOT_SATISFIABLE
    ...
    static constexpr Value PRECONDITION_REQUIRED = Value::PRECONDITION_REQUIRED; ///< @see Value::PRECONDITION_REQUIRED
    static constexpr Value TOO_MANY_REQUESTS = Value::TOO_MANY_REQUESTS; ///< @see Value::TOO_MANY_REQUESTS
    static constexpr Value REQUEST_HEADER_FIELDS_TOO_LARGE = Value::REQUEST_HEADER_FIELDS_TOO_LARGE; ///< @see Value::REQUEST_HEADER_FIELDS_TOO_LARGE
    static constexpr Value UNAVAILABLE_FOR_LEGAL_REASONS = Value::UNAVAILABLE_FOR_LEGAL_REASONS; ///< @see Value::UNAVAILABLE_FOR_LEGAL_REASONS
    // Server Error 5xx
    static constexpr Value INTERNAL_SERVER_ERROR = Value::INTERNAL_SERVER_ERROR; ///< @see Value::INTERNAL_SERVER_ERROR
    ...
    static constexpr Value HTTP_VERSION_NOT_SUPPORTED = Value::HTTP_VERSION_NOT_SUPPORTED; ///< @see Value::HTTP_VERSION_NOT_SUPPORTED
    static constexpr Value VARIANT_ALSO_NEGOTIATES = Value::VARIANT_ALSO_NEGOTIATES; ///< @see Value::VARIANT_ALSO_NEGOTIATES
    ...
    static constexpr Value NETWORK_AUTHENTICATION_REQUIRED = Value::NETWORK_AUTHENTICATION_REQUIRED; ///< @see Value::NETWORK_AUTHENTICATION_REQUIRED
    ...
    static constexpr Value REQUEST_HEADER_FIELDS_TOO_LARGE_UNOFFICIAL = Value::REQUEST_HEADER_FIELDS_TOO_LARGE_UNOFFICIAL;
