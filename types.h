...
public:
    ...
    friend std::ostream &
    operator<<(std::ostream &os, const Method &m) {
...
public:
    ...
    constexpr bool
    operator<(Value v) const {
        return qb::to_underlying(_value) < qb::to_underlying(v);
    }

    /// Equality comparison with raw ::http_status.
    constexpr bool
    operator==(::http_status s) const {
        return static_cast<::http_status>(*this) == s;
    }
    ...
    operator==(int i) const {
        return qb::to_underlying(_value) == i;
    }
    ...
    operator ::http_status() const {
        return static_cast<::http_status>(_value);
    }
    ...
    code() const {
        return qb::to_underlying(_value);
    }
    /// Convert to std::string_view (e.g., "OK", "Not Found").
    [[nodiscard]] std::string_view
    str() const {
...
struct hash<qb::http::method> {
     ...
     */
    [[nodiscard]] size_t
    operator()(qb::http::method const &m) const noexcept {
...
struct hash<qb::http::status> {
     ...
     */
    [[nodiscard]] size_t
    operator()(qb::http::status const &s) const noexcept {
...
to_string(qb::http::method m) noexcept {
    return std::string(m);
}
