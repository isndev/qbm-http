 ...
 */
[[nodiscard]] std::optional<std::chrono::system_clock::time_point> parse_http_date(std::string_view str) noexcept;
 ...
 * @note This function is `noexcept`.
 */
[[nodiscard]] std::optional<std::chrono::system_clock::time_point> parse_http_date(const std::string &str) noexcept;
 ...
 * @note This function is `noexcept`.
 */
[[nodiscard]] std::optional<std::chrono::system_clock::time_point> parse_cookie_date(std::string_view str) noexcept;
 ...
 * @note This function is `noexcept`.
 */
[[nodiscard]] std::optional<std::chrono::system_clock::time_point> parse_cookie_date(const std::string &str) noexcept;
 ...
 */
[[nodiscard]] std::string format_timestamp(const std::chrono::system_clock::time_point &tp) noexcept(false);
} // namespace date
} // namespace qb::http
