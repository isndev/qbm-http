...
public:
     ...
     */
    Result &
    set_error_value_policy(ErrorValuePolicy policy, std::size_t preview_bytes = 256) noexcept {
     ...
     */
    void
    add_error(std::string field_path, std::string rule_violated, std::string message, std::optional<qb::json> offending_value = std::nullopt) {
