...
namespace qb::http::validation {
    ...
    SchemaValidator::create_rules_for_schema_node(const qb::json &schema_node) const {
        ...
        if (schema_node.contains("uniqueItems") && schema_node["uniqueItems"].is_boolean() && schema_node["uniqueItems"]
            .get<bool>()) {
        ...
        if (type_ok) {
            if (current_value.is_object()) {
                ...
                if (current_schema.contains("properties")) {
                    if (!validate_properties_keyword(current_value, current_schema["properties"], current_path,
                                                     result)) {
                ...
                structural_ok = properties_check_passed && required_check_passed && additional_properties_check_passed
                                && property_names_check_passed;
    ...
    bool SchemaValidator::validate_type_keyword(const qb::json &value, const qb::json &schema_type_def,
                                                const std::string &path, Result &result) const {
    ...
    bool SchemaValidator::validate_properties_keyword(const qb::json &value, const qb::json &properties_def,
                                                      const std::string &path, Result &result) const {
    ...
    bool SchemaValidator::validate_required_keyword(const qb::json &value, const qb::json &required_def,
                                                    const std::string &path, Result &result) const {
        if (!value.is_object()) return true;
    ...
    bool SchemaValidator::validate_items_keyword(const qb::json &value, const qb::json &schema_node,
                                                 const std::string &path, Result &result) const {
    ...
    bool SchemaValidator::validate_allOf_keyword(const qb::json &value, const qb::json &allOf_def,
                                                 const std::string &path, Result &result) const {
