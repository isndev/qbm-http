...
<!-- src: qbm/http/src/qbm/http/2/http2.h:224-234,538; qbm/http/src/qbm/http/2/client.cpp:395,415,870-889 -->
...
<!-- src: qbm/http/src/qbm/http/2/protocol/server.h:305,339,449,730-779,795-894,884-893; qbm/http/src/qbm/http/2/http2.h:166; qbm/http/src/qbm/http/2/client.cpp:585-605,607-633,904-917 -->
...
<!-- src: qbm/http/src/qbm/http/2/protocol/server.h:445-450,1474; qbm/http/src/qbm/http/2/http2.h:64; qbm/http/src/qbm/http/2/client.h:210,400 -->
...
<!-- src: qbm/http/src/qbm/http/2/client.h:164,248-251,253-256,641 -->
...
<!-- src: qbm/http/src/qbm/http/2/client.h:324,347; qbm/http/tests/system/http2/http2-client-coro.cpp:264-285 -->
...
```cpp
// src: qbm/http/src/qbm/http/2/client.h:406-413; qbm/http/src/qbm/http/2/client.cpp:247-252,304-309
...
```
<!-- src: qbm/http/src/qbm/http/2/client.h:324,347,406-413 -->
...
<!-- src: qbm/http/src/qbm/http/2/client.h:261-266,288,328-329,351-352,361-365 -->
...
- **Server concurrency defaults to 50, client to 100.** They are independent: the server's `SETTINGS_MAX_CONCURRENT_STREAMS = 50` bounds inbound client streams (excess gets `REFUSED_STREAM`); `client->set_max_concurrent_streams(...)` bounds the client's outbound *in-flight* streams (default 100). Raise the server limit only if you have measured headroom.
  <!-- src: qbm/http/src/qbm/http/2/protocol/server.h:445-450; qbm/http/src/qbm/http/2/client.h:210,400 -->
- **The client also caps total outstanding requests.** Separate from stream concurrency, `set_max_pending_requests(...)` (default 1024) bounds queued + active requests; past it `push_request()`/`push_requests()` reject with `503 Service Unavailable` instead of queuing without limit. Tune it down for tighter backpressure, not up without a reason.
  <!-- src: qbm/http/src/qbm/http/2/client.h:212,406-413; qbm/http/src/qbm/http/2/client.cpp:247-252 -->
- **The client is non-movable; keep the `shared_ptr`.** Constructing one on the stack or trying to move it will not compile. Use `make_client(...)` and store the returned `std::shared_ptr`.
  <!-- src: qbm/http/src/qbm/http/2/client.h:164,253-256,641 -->
- **`set_verify_peer` must precede `connect`.** Changing it after the handshake has no effect. Leave it `true` in production; flip to `false` only for trusted self-signed test endpoints.
  <!-- src: qbm/http/src/qbm/http/2/client.h:377-384 -->
- **Coroutine `connect()` has no default callback.** For fire-and-forget, write `connect(nullptr)`; bare `connect()` is the coroutine awaiter overload.
  <!-- src: qbm/http/src/qbm/http/2/client.h:261-266 -->
