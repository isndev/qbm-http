...
<!-- src: qbm/http/routing/router.h:115-141 (QB_HTTP_ROUTER_VERB) -->
```cpp
template <typename H>
...
<!-- src: qbm/http/routing/router.h:127-133 (member-fn overload) -->
```cpp
...
<!-- src: qbm/http/routing/router.h:89 -->
```cpp
...
<!-- src: qbm/http/routing/context.h:505-565 -->
```cpp
...
<!-- src: qbm/http/routing/context.h:423-565 -->
```cpp
...
```cpp
#include <http/http.h>
#include <http/coro.h>  // co_await qb::http::GET (coroutine client) + run_sync
