...
<!-- src: qbm/http/src/qbm/http/1.1/http.h:687-690 -->
```cpp
...
<!-- src: qbm/http/src/qbm/http/1.1/http.h:904-909 -->
```cpp
...
<!-- src: qbm/http/src/qbm/http/1.1/http.h:1038-1043 -->
```cpp
namespace qb::http {
...
<!-- src: qbm/http/src/qbm/http/retry_policy.h:34-40; qbm/http/src/qbm/http/2/client.h:448-473 -->
```cpp
